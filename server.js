...
// Modelos existentes
const Post = require('./models/Post');           // { user: nickname, content, tags, likes, likedBy, createdAt }
...
const getUserLite = async id => {
  ...
  return u
    ? { _id: u._id, nickname: u.nickname, points: u.points, pendingPoints: u.pendingPoints, qrId: u.qrId, profilePic: u.profilePic }
    : null;
};
...
/* ===================== QR ===================== */
// QR autenticado: payload con id y nickname (dataURL)
...
// Compat (si algún front viejo lo usa)
...
// Sumar asistencia manual (por compatibilidad)
